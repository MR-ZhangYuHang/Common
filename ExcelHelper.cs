...
namespace DBUtility
{
    ...
    public class ExcelHelper
    {
        ...
        public static void DataTable1Excel(System.Data.DataTable dtData)
        {
            ...
            System.Diagnostics.Debug.WriteLine("执行到这里了  看看");
        }
        ...
        {
            string strConn = string.Format("Provider=Microsoft.ACE.OLEDB.12.0;Data Source={0};Extended Properties='Excel 8.0;HDR=Yes;IMEX=1;'", ExcelFileName);
            DataTable dt = new DataTable();
            ArrayList TablesList = new ArrayList();
            if (File.Exists(ExcelFileName))
            {
                using (OleDbConnection conn = new OleDbConnection(strConn))//"Provider=Microsoft.Jet.OLEDB.4.0;Extended Properties=Excel 8.0;Data Source=" + ExcelFileName
                {
                    try
                    {
                        conn.Open();
        ...
        public static DataTable InputFromExcel(string ExcelFilePath, string TableName)
        {
            ...
            OleDbConnection dbcon = new OleDbConnection(strConn);//@"Provider=Microsoft.Jet.OLEDB.4.0;Data Source=" + ExcelFilePath + ";Extended Properties=Excel 8.0"
